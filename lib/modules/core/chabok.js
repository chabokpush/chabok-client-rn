...
export class AdpPushClient {
    ...
    initLocation = () => AdpNativeModule.initLocation();
    enableBackgroundMode = () => AdpNativeModule.enableBackgroundMode();
    disableBackgroundMode = () => AdpNativeModule.disableBackgroundMode();
    enableLocationOnLaunch = () => AdpNativeModule.enableLocationOnLaunch();
    getLastLocation = () => AdpNativeModule.getLastLocation();
    startLocationUpdates = ( distance, interval ) => AdpNativeModule.startLocationUpdates( distance, interval );
